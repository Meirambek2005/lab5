...
HD_PWD='C:/Users/admin/lab5_10/lab5_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T_trigger.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T_trigger.tcl
